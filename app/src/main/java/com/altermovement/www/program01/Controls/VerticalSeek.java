...
import com.altermovement.www.program01.R;

import java.lang.reflect.InvocationTargetException;
import java.lang.reflect.Method;

public class VerticalSeek extends AppCompatSeekBar {
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.VerticalSeek, defStyleAttr, defStyleRes);
            final int rotationAngle = a.getInteger(R.styleable.VerticalSeek_seekBarRotation, 0);
